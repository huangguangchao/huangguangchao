...
//遍历的输出
void LPrint(void *q, int type) {//根据字节数来输出多类型数据
	if (type == sizeof (int))
	printf("%d", *(int *)q);
...
void mainmenuface()
{
    ...
    printf("                            功能系统                                    \n");
    printf("                                                                        \n");
    printf("           1.初始化队列           5. 确定队列长度 			    \n");
    printf("                                                                        \n");
    printf("           2.销毁队列              6.入队操作    		    \n");
    printf("                                                                        \n");
    printf("           3. 检查队列是否为空           7.出队操作                    \n");
    printf("                                                                        \n");
    printf("           4.查看队头元素              8.清空队列	                  \n");
    printf("                                                                        \n");
    printf("	   9.遍历函数操作	  			     \n");
}
